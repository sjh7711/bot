module.exports = (function(){
   ...
   function DBManagerBuilder(fileName){
      ...
      function rawQueryForMap(sql,selectionArgs){
         try{
            return cursorToMap(rawQueryForCursor(sql,selectionArgs));
         }catch(e){throw e;}
      }
      ...
      function selectForMap(table, columns, selection, selectionArgs, options){
         try{
            return cursorToMap(selectForCursor(table, columns, selection, selectionArgs, options));
         }catch(e){throw e;}
      }
