...
21을 초과하게 되었을 경우에는 Bust 라고 하며 딜러의 결과에 관계없이 무조건 건 금액을 잃게 됩니다. Push는 딜러와 무승부인 상황일 경우입니다. 이 경우 배팅액을 그대로 돌려받습니다.\n\
딜러의 오픈카드가 10, J, Q, K 일 떈, 딜러가 블랙잭인지 아닌지 말을 해줍니다. 딜러의 오픈카드가 A일 경우 Insurance를 설정할 수 있습니다. 딜러가 블랙잭인 경우 플레이어는 블랙잭이 아닌 이상 모두 바로 패배처리됩니다.\n\
같은 블랙잭이면 배팅한 금액을 그대로 돌려받습니다. 플레이어가 블랙잭인 경우 딜러가 블랙잭이 아닌 이상 승리합니다.\n\
[참가] 를 입력하면 참가가 가능하고 [!블랙잭] 을 외친 사람이 [시작] 이라고 입력하면 게임을 시작합니다.\n\
처음엔 베팅할 금액을 정합니다. 1만원~50만원의 배팅이 가능합니다.\n\
Insurance는 보험입니다. 딜러의 오픈된 카드가 A일 경우, 딜러가 블랙잭이 나올 가능성에 대비해 보험을 들어두는 것입니다. 자기가 배팅한 금액의 절반까지 보험금으로 추가로 맡길 수 있습니다. 만약 딜러가 블랙잭이면 보험금의 2배를 돌려받습니다. 배팅한 금액은 잃습니다. 만약 딜러가 블랙잭이 아니고 게임을 지게되면 보험금 + 배팅금을 다 잃게됩니다.\n\
EvenMoney는 플레이어가 블랙잭이고 딜러의 오픈된 카드 한장이 A일 때 같은 블랙잭으로 무승부 되는 경우를 대비한 보험입니다. 베팅한 금액과 동일한 금액을 승리수당으로 받고 게임을 종료할 것인지, 아니면 블랙잭의 효과(1.5배)를 그대로 유지하면서 게임을 계속 진행할 것인지에 대해 선택을 하는 것입니다.\n\
[힛]은 카드를 한 장 더 받는 것입니다.\n\
[스테이]는 카드를 더 이상 받지 않겠다는 의미입니다.\n\
[더블다운]은 버스트만 되지 않는다면 무한정 받을 수 있는 기존의 룰에서 벗어나 카드를 단 한 장만 더 받고 돈을 두 배로 걸 수 있습니다.\n\
