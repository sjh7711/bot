...
function func(r) {
    ...
    if (r.msg.split(" ")[1] == "날씨") {
        r.replier.reply("기본값으로 무전동 날씨를 보여줍니다. !날씨 지역명으로 검색가능하며 경우에 따라 선택을 해야할 수도 있습니다.");
    }
    if (r.msg.split(" ")[1] == "건의") {
	...
	I.register("weatherSelect",r.room,r.sender,function(input){
		try{
			...
			if(check > 0){
				...
				var res = where+"\n";
				res += "";
				res += String.fromCharCode(9200)+" ℃  "+String.fromCharCode(9200)+" 습도 바람[m/s] 날씨\n";
