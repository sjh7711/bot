...
function baseball(r){
	if( (Flag.get('start', r.room) == 1 || Flag.get('start1', r.room) == 1 ||  Flag.get('start2', r.room) ==  1) && r.msg == '!강제종료' && ( (Flag.get('baseballtime', r.room ) + 6000*8*60 ) < new Date().getTime() ) && Flag.get('baseball', r.room).length > 1 ){
