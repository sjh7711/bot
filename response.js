...
21을 초과하게 되었을 경우에는 Bust 라고 하며 딜러의 결과에 관계없이 무조건 건 금액을 잃게 된니다. Push는 딜러와 무승부인 상황일 경우입니다. 이 경우 배팅액을 그대로 돌려받습니다.\n\
딜러가 블랙잭인 경우 플레이어는 블랙잭이 아닌 이상 모두 패배처리됩니다. 같은 블랙잭이면 배팅한 금액을 그대로 돌려받습니다. 플레이어가 블랙잭인 경우 딜러가 블랙잭이 아닌 이상 승리합니다.\n\
